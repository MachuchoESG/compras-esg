            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div>
                        ...
                        <select wire:model.live="producto.id_Producto" class="select2 w-full" id="productoSelect" required>
                ...
                <div class="modal-footer">
                    <x-button wire:click="save" class="ml-2 bg-blue-500 hover:bg-blue-700">Guardar</x-button>
                </div>
