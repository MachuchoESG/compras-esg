    ...
    <div class="relative overflow-x-auto rounded-lg" style="height: 50vh">
        <table class="w-full  shadow-lg text-sm text-left rtl:text-right text-gray-500 ">
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="3" class="px-6 py-3 text-center">Aun no cuentas con departamentos registrados.
                        </td>
                    </tr>
                @endforelse
        ...
        <x-slot name='content'>
            <form wire:submit.prevent="update">
                ...
                <div>
                    ...
                    <x-input class="w-full" wire:model="departamentoEdit.name" type="text" id="name"
                        name="name" required />
                </div>
