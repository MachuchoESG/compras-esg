<div class="p-4 border rounded mb-4">
    <div class="w-full md:flex md:justify-between md:items-center">
        ...
        <button wire:click.prevent="download({{ $requisicion->evidencia()->first()->id }})" class=" relative inline-flex items-center  px-1 py-2 text-sm font-medium rounded-lgfocus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 ">
