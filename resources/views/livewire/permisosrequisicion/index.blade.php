                    ...
                    <tr class="bg-white border">
                        ...
                        <td class="px-6 py-3 text-center">
                            <div class="flex  justify-center">
                                <button wire:click=" edit({{ $permiso->id }})"
    ...
    <x-dialog-modal wire:model='openEdit'>
        ...
        <x-slot name='content'>
            <form>
                ...
                <div class="w-full">
                    ...
                    <select wire:model="permisoEdit.PuestoSolicitante_id"
                        class="border-1 border-slate-900 rounded-md w-full  text-black text-md capitalize">
                ...
                <div class="w-full">
                    ...
                    <select wire:model="permisoEdit.PuestoAutorizador_id"
                        class="border-1 border-slate-900 rounded-md w-full  text-black text-md capitalize">
                        <option value="" selected disabled>
                            Seleccione un puesto
                        </option>
                ...
                <div class="w-full">
                    ...
                    <select wire:model="permisoEdit.Departamento_id"
                        class="border-1 border-slate-900 rounded-md w-full  text-black text-md capitalize">
                        <option value="" selected disabled>
                ...
                <div>
                    ...
                    <input wire:model="permisoEdit.monto" class="w-full h-10 border rounded-lg mb-2" type="number"
        ...
        <x-slot name='footer'>
            ...
            <x-button class="bg-blue-500 hover:pointer text-white font-bold"
                wire:click="$set('openEdit', false)">Cancelar</x-button>
        </x-slot>
