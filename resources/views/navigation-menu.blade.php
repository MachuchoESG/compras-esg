<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 w-100">
        ...
        <div class="flex h-16">
            ...
            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                ...
                @if (auth()->user()->departamento_id == 1)
                    ...
                    <x-nav-link href="{{ route('puesto.index') }}" :active="request()->routeIs('puesto.index')">
                        {{ __('Puestos') }}
                    </x-nav-link>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link href="{{ route('requisicion.index') }}" :active="request()->routeIs('requisicion.index')">
                {{ __('Requisiciones') }}
            </x-responsive-nav-link>
